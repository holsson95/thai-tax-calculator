export interface FAQItem {
  question: string;
  answer: string;
  /** Slug of the single best "read more" article for this question, where one clearly exists. */
  relatedArticleSlug?: string;
  /** Id of the TAX_SOURCES entry (src/data/sources.ts) backing this answer's central claim, where a confident match exists. */
  sourceId?: string;
}
    ...
    items: [
      {
        ...
        relatedArticleSlug: 'transferring-money-to-thailand-tax-rules',
        sourceId: 'mahanakorn-remittance-rule',
      },
      {
      ...
      },
      {
        ...
        relatedArticleSlug: 'how-to-get-thai-tax-id-number',
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        relatedArticleSlug: 'pensioner-retiree-tax-guide-thailand',
      },
      {
        ...
        relatedArticleSlug: 'foreign-pension-income-thailand-tax',
        sourceId: 'mahanakorn-remittance-rule',
      },
      {
      ...
      },
      {
        ...
        relatedArticleSlug: 'foreign-pension-income-thailand-tax',
        sourceId: 'irs-us-thailand-treaty',
      },
      {
        ...
        relatedArticleSlug: 'expat-guide-filing-thai-taxes',
      },
      {
        ...
        relatedArticleSlug: 'ltr-visa-tax-benefits',
        sourceId: 'boi-decree-743',
      },
      {
        ...
        relatedArticleSlug: 'thailand-retirement-visa-tax-obligations',
      },
      {
        ...
        relatedArticleSlug: 'investment-income-retirees-thailand',
      },
      {
        ...
        relatedArticleSlug: 'maximizing-tax-deductions-thailand',
        sourceId: 'msna-parents-allowance',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        relatedArticleSlug: 'double-tax-agreements-thailand',
        sourceId: 'rd-dta-list',
      },
      {
    ...
    items: [
      {
        ...
        relatedArticleSlug: 'expat-guide-filing-thai-taxes',
        sourceId: 'nishimura-efiling-extension',
      },
      {
    ...
    items: [
      {
        ...
        relatedArticleSlug: 'how-to-use-the-thai-tax-calculator',
        sourceId: 'rd-wht-table',
      },
      {
        ...
        relatedArticleSlug: 'foreign-income-thailand-tax',
        sourceId: 'mahanakorn-remittance-rule',
      },
      {
        ...
        relatedArticleSlug: 'thai-tax-brackets-explained',
        sourceId: 'sherrings-rates',
      },
      {
      ...
      },
      {
        ...
        relatedArticleSlug: 'rental-income-tax-thailand',
      },
      {
    ...
    items: [
      {
        ...
        relatedArticleSlug: 'thailand-tax-guide-for-expats',
      },
      {
        ...
        relatedArticleSlug: 'digital-nomad-taxes-thailand',
        sourceId: 'mahanakorn-remittance-rule',
      }
    ]
  }
